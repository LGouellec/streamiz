...
namespace Streamiz.Kafka.Net.Tests.Private
{
    public class ByteBufferTests
    {
        ...
        public void ByteBufferReadOperation()
        {
            ...
            var buffer = ByteBuffer.Build(readArray, false);
        ...
        public void ByteBufferWriteOperation()
        {
            ...
            var buffer = ByteBuffer.Build(16, false);
            buffer.PutLong(l);
            buffer.PutInt(i);
            buffer.Put(array);
        ...
        public void ByteBufferMixReadWriteOperation()
        {
            ...
            var buffer = ByteBuffer.Build(0, false);
            buffer.PutLong(l);
        ...
        public void ByteBufferWriteBytesArray()
        {
            ...
            var buffer2 = ByteBuffer.Build(array2, false);
