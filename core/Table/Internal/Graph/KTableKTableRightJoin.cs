...
namespace Streamiz.Kafka.Net.Table.Internal.Graph
{
    ...
    {
        public KTableKTableRightJoin(IKTableGetter<K, V1> table1, IKTableGetter<K, V2> table2, IValueJoiner<V1, V2, VR> valueJoiner, string joinResultTopic = null)
        ...
        public override IProcessor<K, Change<V1>> Get()
            => new KTableKTableRightJoinProcessor<K, V1, V2, VR>(table2.ValueGetterSupplier.Get(), valueJoiner, sendOldValues, joinResultTopic);
    }
}
