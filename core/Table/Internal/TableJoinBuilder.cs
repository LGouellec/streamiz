...
namespace Streamiz.Kafka.Net.Table.Internal
{
    internal class TableJoinBuilder
    {
            ...
            Materialized<K, VR, IKeyValueStore<Bytes, byte[]>> materializedInternal)
        {
            ...
            IStoreBuilder<ITimestampedKeyValueStore<K, VR>> storeBuilder = queryableStoreName != null ? new TimestampedKeyValueStoreMaterializer<K, VR>(materializedInternal).Materialize() : null;
