...
{
    internal class WindowStoreMaterializer<K, V, W>
        where W : Window
    {
        ...
        public IStoreBuilder<IWindowStore<K, V>> Materialize()
        {
            ...
            var builder = Stores.WindowStoreBuilder(supplier, materializedInternal.KeySerdes, materializedInternal.ValueSerdes);
